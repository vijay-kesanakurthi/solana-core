...
const TOKEN_NAME = "Peace";
const TOKEN_SYMBOL = "PEC";
const TOKEN_DESCRIPTION = "A token for peace";
const TOKEN_IMAGE_NAME = "./src/headphones.png"; // Replace unicorn.png with your image name
